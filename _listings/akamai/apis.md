...
- name: Akamai API Get an HD Config Policy per Environment
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/media/master/_listings/akamai/config-media-security-v1-security-live-domain-policy-environment-get.md
x-common:
- type: x-base
