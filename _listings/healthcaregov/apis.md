...
- name: Healthcare.gov Get State Name Media Type Extension
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/media/master/_listings/healthcaregov/es-statename-mediatypeextension-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/media/master/_listings/healthcaregov/es-statename-mediatypeextension-get-postman.md
x-common:
- type: x-developer
