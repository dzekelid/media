...
- name: Healthcare.gov Get Question Page Name Media Type Extension
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/media/master/_listings/healthcaregov/es-question-pagename-mediatypeextension-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/media/master/_listings/healthcaregov/es-question-pagename-mediatypeextension-get-postman.md
x-common:
- type: x-developer
